...
.PHONY: viz_silly_install
viz_silly_install: ## Create a lockfile for the viz_silly environment
	-conda env remove -n viz_silly
	conda-lock install -n viz_silly ./viz_silly_lock.yml
